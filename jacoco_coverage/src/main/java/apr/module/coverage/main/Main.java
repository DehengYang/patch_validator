package apr.module.coverage.main;
...
import apr.module.coverage.coverage.MemoryClassLoader;
import apr.module.coverage.util.Util;
...
//			analyzedClasses.add(ac);
		List<String> lines = Util.readLines(new File(args[3]));
		analyzedClasses.addAll(lines);
