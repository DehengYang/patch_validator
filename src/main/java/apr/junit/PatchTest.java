...
public class PatchTest {
    ...
    public static void writeLinesToFile(String path, List<String> lines, boolean append) {
        ...
        if (!dir.exists()) {
            dir.mkdirs();
            System.out
                    .println(String.format("%s does not exists, and are created now via mkdirs()", dirPath));
        }
    ...
    public static void runTestMethods(List<String> testMethods) {
        ...
        // @/mnt/benchmarks/buggylocs/Defects4J/Defects4J_Closure_103/Dale_APR/FL/test_methods.txt
        // none is perfect.
    ...
    private static void setParameters(String[] args) {
        ...
        Option opt1 = new Option("testFile", "testFile", true,
                "a file containing tests like org.apache.commons.math3.stat.StatUtilsTest#testSumLog (test methods or tests)");
        opt1.setRequired(false);
        Option opt2 = new Option("testStr", "testStr", true,
                "some tests linked with : (test methods or tests)");
        ...
        Option opt5 = new Option("extraFailedMethodPath", "extraFailedMethodPath", true,
